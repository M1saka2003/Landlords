...
void ButtonGroup::initButtons() {
    ...
    ui->playCard1->setImage(":/ /images/chupai_btn-1.png", ":/ /images/chupai_btn-3.png",
...
void ButtonGroup::selectPanel(Panel type, int bet) {
    ...
    if (bet == 0) {
        ...
        ui->threeScore->setVisible(false);
    }
}
